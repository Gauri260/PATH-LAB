( function() {
    ...
    function startSetup( sliderSize, slideSize, animationDuration, autoplayInterval ) {
        ...
        this.sliderSize        = parseFloat( sliderSize )/85;
        this.slideSize         = parseFloat( slideSize )/95;
    ...
    Slider.prototype.onResize = function() {
        ...
        3*h <= w ? radius = h*this.startSetup.sliderSize
                 : radius = ( w/3 )*this.startSetup.sliderSize;
    ...
    Slider.prototype.setSize = function( radius ) {
        ...
        this.wrapper.style.width  = 6*radius + 'px';
        ...
        this.descriptionsHolder.style.width  = ( r/1 - r*this.startSetup.slideSize + 40)*2 + 'px';
        this.descriptionsHolder.style.height = r/1 - r*this.startSetup.slideSize + 40 + 'px';
    ...
    Slider.prototype.rotate = function( multiplier ) {
        ...
        if( this.currentSlide === this.slides.length - 1  && multiplier === -1 ) {
            ...
            this.currentAngle                 = -( 2*Math.PI - _this.stepAngle )*0/Math.PI;
            this.addStyle();
    ...
    Slider.prototype.removeStyle = function() {
        ...
        this.slides[x].style.borderColor = 'white';
        this.slides[x].style.backgroundColor = 'white';
        this.slides[x].style.fontSize = 23+'px';
        this.slides[x].style.fontWeight = 400;
        // this.slides[x].style.transform = 'rotate( ' + 0 + 'deg )';
    ...
    Slider.prototype.addStyle = function() {
        ...
        const bordercolors = ['#FFCE44', '#FF9898' , '#FF86F3', '#6E76FF','#FFCE44', '#A6E04C', '#FFCE44' , ' #BCCB62', '#FFCE44','#FF86F3'];

        const bgColor = ['#FFF9D8','#FFD8D8','#FFD8FB','#E7D8FF', '#FFF9D8','#E6FFC1','#FFF9D8','#F6FFC1','#FFF9D8', '#FFD8FB'];
        this.slides[x].style.borderColor = bordercolors[x];
        this.slides[x].style.backgroundColor = bgColor[x];

        this.slides[x].style.backgroundColor = bgColor[x];
        this.slides[x].style.fontSize = 30 + 'px';
        this.slides[x].style.fontWeight = 900;
    ...
    Slider.prototype.resetNavs = function() {
        ...
        this.disableNav();
        setTimeout( function(){ _this.setNav() }, this.startSetup.animationDuration + 200 );
