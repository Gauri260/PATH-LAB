    ...
    pDpN: function(e, t, n) {
            ...
            class i {
                ...
                runTask(e, t, n) {
                    ...
                    try {
                        ...
                        e.state !== v && e.state !== Z && (e.type == P || e.data && e.data.isPeriodic ? o && e._transitionTo(b, E) : (e.runCount = 0,
        ...
        function S(e, t, n) {
            ...
            s.set = function(t) {
                let n = this;
                n || e !== _ || (n = _),
                n && (n[u] && n.removeEventListener(l, Z),
                c && c.apply(n, k),
                "function" == typeof t ? (n[u] = t,
                n.addEventListener(l, Z, !1)) : n[u] = null)
            }
            ,
            s.get = function() {
                let n = this;
        ...
        function O(e) {
            ...
            for (o in n)
                "XMLHttpRequest" === e && "responseBlob" === o || function(t) {
                    ...
                    : r(_[e].prototype, t, {
                        set: function(n) {
                            "function" == typeof n ? (this[P][t] = h(n, e + "." + t),
                            j(this[P][t], n)) : this[P][t] = n
                        },
                        get: function() {
                            return this[P][t]
                        }
            ...
            for (o in t)
                "prototype" !== o && t.hasOwnProperty(o) && (_[e][o] = t[o])
        }
        function C(e, t, n) {
            let r = e;
            ...
            const a = f(t);
            let i = null;
            if (r && (!(i = r[a]) || !r.hasOwnProperty(a)) && (i = r[a] = r[t],
            y(r && o(r, t)))) {
                const e = n(i, a, t);
                r[t] = function() {
        ...
        function B(e, t, n) {
              ...
              , p = function(t) {
                ...
                if (o)
                    if (1 === o.length)
                        ...
                        const e = o.slice();
                        for (let o = 0; o < e.length && (!t || !0 !== t[q]); o++)
                            h(e[o], n, t)
                    }
            }
              , d = function(t) {
            ...
            function g(t, n) {
                ...
                const P = h ? function(e) {
                    if (!v.isExisting)
                        return b.call(v.target, v.eventName, v.capture ? d : p, v.options)
                }
                : function(e) {
                  ...
                  , O = h ? function(e) {
                    ...
                    if (e.allRemoved)
                        return E.call(e.target, e.eventName, e.capture ? d : p, e.options)
                }
                : function(e) {
                  ...
                  , R = function(t, o, r, s, a=!1, i=!1) {
                    return function() {
                        ...
                        R && (R.taskData = null),
                        m && (d.once = !0),
                        (x || "boolean" != typeof M.options) && (M.options = d),
                        M.target = c,
                        M.capture = k,
                        M.eventName = l,
                        p && (M.originalDelegate = u),
                        i ? S.unshift(M) : S.push(M),
                        a ? c : void 0
                    }
                };
                return m[o] = R(b, l, P, O, k),
                S && (m.prependListener = R(S, ".prependListener:", function(e) {
                    ...
                    if (l)
                        for (let e = 0; e < l.length; e++) {
                            ...
                            if (C(n, a))
                                ...
                                t[c] = null,
                                "string" == typeof o) && (t[u + "ON_PROPERTY" + o] = null),
                                n.zone.cancelTask(n),
                                k ? t : void 0
                        }
                    return E.apply(this, arguments)
        ...
        function ae(e, t) {
            ...
            if (b) {
                ...
                se(e, oe.concat(["messageerror"]), o ? o.concat(t) : o, s(e)),
                se(Document.prototype, oe, o),
                void 0 !== e.SVGElement && se(e.SVGElement.prototype, oe, o),
                se(Element.prototype, oe, o),
                se(HTMLElement.prototype, oe, o),
                se(HTMLMediaElement.prototype, X, o),
                se(HTMLFrameSetElement.prototype, $.concat(Y), o),
                se(HTMLBodyElement.prototype, $.concat(Y), o),
                se(HTMLFrameElement.prototype, J, o),
                se(HTMLIFrameElement.prototype, J, o);
            ...
            a && se(a && a.prototype, Q, o),
            "undefined" != typeof IDBIndex && (se(IDBIndex.prototype, ee, o),
            se(IDBRequest.prototype, ee, o),
            se(IDBOpenDBRequest.prototype, ee, o),
            se(IDBDatabase.prototype, ee, o),
            se(IDBTransaction.prototype, ee, o),
            se(IDBCursor.prototype, ee, o)),
            n && se(WebSocket.prototype, te, o)
        }
        Zone.__load_patch("util", (e, t, n) => {
            n.patchOnProperties = D,
            n.patchMethod = C,
            n.bindArguments = m,
            n.patchMacroTask = z;
            ...
            n.filterProperties = re,
            n.attachOriginToPatched = j,
        ...
        function ce(e, t, n, o) {
            ...
            r = C(e, t += o, n => function(r, s) {
                if ("function" == typeof s[0]) {
                    ...
                    return "number" == typeof l ? a[l] = r : l && (l[ie] = r),
            ...
            s = C(e, n, t => function(n, o) {
                const r = o[0];
                let s;
                "number" == typeof r ? s = a[r] : (s = r && r[ie],
                s || (s = r)),
                s && "string" == typeof s.type ? "notScheduled" !== s.state && (s.cancelFn && s.data.isPeriodic || 0 === s.runCount) && ("number" == typeof r ? delete a[r] : r && (r[ie] = null),
        ...
        Zone.__load_patch("XHR", (e, t) => {
            !function(e) {
                ...
                function _(e) {
                    ...
                    ;
                    return d.call(a, "readystatechange", h),
                    a[n] || (a[n] = e),
                    b.apply(a, o.args),
                    a[s] = !0,
                    e
        ...
        Zone.__load_patch("PromiseRejectionEvent", (e, t) => {
            ...
            e.PromiseRejectionEvent && (t[f("unhandledPromiseRejectionHandler")] = n("unhandledrejection"),
