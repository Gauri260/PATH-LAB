                    ...
                    e.exports = new c(function(c, e) {
                        ...
                        o.listen(function(c, d, f) {
                            ...
                            try {
                                ...
                                h != null && h !== "" && (g = n(h + c.id + d),
                                g == null ? g = "" : g = g.substring(0, k))
                            } catch (a) {
                                f = "[PDM]";
                ...
                (function() {
                    ...
                    function m(a, b) {
                        ...
                        if (c === "and") {
                            ...
                            return !m(e, b);
                        else if (d.includes(g(e).toLowerCase()))
                            return k(a, e, b);
                        else
                            return i(a, e, b)
                    }
                ...
                (function() {
                    ...
                    function m(a, b, c, d) {
                        ...
                        j(d, function(a) {
                            try {
                                ...
                                if (c == null || a == null)
                                    return;
                                g(a, b) && (typeof c === "number" && (c = c.toString()),
                                e.push(c))
                            } catch (b) {
                                a = "[CC]";
                    ...
                    e.exports = new a(function(a, d) {
                        b.listen(function(b, e) {
                            ...
                            if (f == null)
                                return {};
                            a.performanceMark("fbevents:start:customConversionProcessing", f);
                            var g = d.optIns.isOptedIn(f, "CCRuleEvaluator");
                            if (!g)
                                return {};
                            g = d.pluginConfig.get(f, "ccRuleEvaluator");
                            if (g == null)
                                return {};
                            var j = g.ccRules
                              , k = g.wcaRules
                              , n = g.valueRules;
                            g = g.blacklistedIframeReferrers;
                            var o = {
                                cs_cc: "1"
                            };
                            if (j != null || k != null || n != null) {
                                e = c(b, e, g);
                                j != null && m(o, e, "ccs", j);
                                n != null && m(o, e, "vrc", n);
                                if (k != null) {
                                    ...
                                    if (g != null && g.length > 0) {
                                        ...
                                        if (j != null && j.length > 0) {
                                            e.url.push(j);
                                            n = l(j);
                                            n != null && (e.domain.push(n.hostname),
                                            e.path.push(n.pathname))
                                        }
                                        e.url.push(g);
                                        b = l(g);
                                        b != null && (e.domain.push(b.hostname),
                                        e.path.push(b.pathname))
                                    }
                                    m(o, e, "cas", k)
                                }
                            }
                            a.performanceMark("fbevents:end:customConversionProcessing", f);
                            return o
                        })
                    }
                    )
                ...
                (function() {
                    ...
                    e.exports = new b(function(b, c) {
                        ...
                        d.listen(function(b, d) {
                            ...
                            b = e.ttlInHour;
                            var f = k(o);
                            if (f != null && (new Date().getTime() - Number(f)) / (1e3 * 60 * 60) < b)
                                return;
                            var g = !1;
                            setTimeout(function() {
                                g || r(e, d)
                            ...
                            try {
                                if (a.RTCPeerConnection != null && a.RTCSessionDescription != null) {
                                    var h = function b() {
                                        s.close(),
                                        a.removeEventListener("freeze", b),
                                        a.removeEventListener("pagehide", b)
                                    };
                                    q++;
                                    f = e.rtcPortNumbers;
                                    var i = d.replace(/\./g, "+");
                                    b = f.map(function(a) {
                                        return "a=candidate:foundation 1 udp 2130706431 127.0.0.1 " + a + " typ host generation 0"
                                    }).join("\n");
                                    var m = "v=0\no=- 521628857 1575883112 IN IP4 0.0.0.0\ns=-\nt=0 0\na=fingerprint:sha-256 E5:74:B0:70:3E:5A:10:AF:67:E9:A7:F5:E5:13:87:F5:45:5D:92:78:46:E8:46:AE:6A:D7:70:70:BE:64:0F:BC\na=group:BUNDLE 0\na=ice-lite\nm=application 9 DTLS/SCTP 5000\nc=IN IP4 0.0.0.0\na=setup:active\na=mid:0\na=sendrecv\na=sctpmap:5000 webrtc-datachannel 1024\na=ice-ufrag:fKVhbscsMWDGAnBg\na=ice-pwd:xGjQkAvKIVkBeVTGWcvCQtnVAeapczwa\n" + b + "\na=end-of-candidates\n"
                                      , s = new a.RTCPeerConnection();
                                    a.addEventListener("pagehide", h);
                                    a.addEventListener("freeze", h);
                                    setTimeout(function() {
                                        h()
                                    }, p);
                                    s.onnegotiationneeded = function(b) {
                                        return s.createOffer().then(function(b) {
                                            b.sdp = b.sdp.replace(/^a=ice-ufrag.*$/m, "a=ice-ufrag:aid+" + i),
                                            b.sdp = b.sdp.replace(/^a=ice-pwd.*$/m, "a=ice-pwd:OEKutPgoHVk/99FfqPOf444w"),
                                            s.setLocalDescription(b),
                                            s.setRemoteDescription(new a.RTCSessionDescription({
                                                type: "answer",
                                                sdp: m
                                            }))
                                        })["catch"](function(a) {
                                            a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[ActionID Error] Web RTC error: " + a.message),
                                            j(a)
                                        })
                                    }
                                    ;
                                    s.oniceconnectionstatechange = function(b) {
                                        s.iceConnectionState === "connected" ? (l(o, new Date().getTime()),
                                        g = !0,
                                        h()) : s.iceConnectionState === "closed" && (a.removeEventListener("freeze", h),
                                        a.removeEventListener("pagehide", h))
                                    }
                                    ;
                                    s.createDataChannel("foo")
                                }
                            } catch (a) {
                                a instanceof Error && Object.prototype.hasOwnProperty.call(a, "message") && (a.message = "[ActionID Error] Web RTC exception: " + a.message),
                                j(a)
                            }
                        })
                    }
...
fbq.registerPlugin("882784148503943", {
    __fbEventsPlugin: 1,
    plugin: function(fbq, instance, config) {
        fbq.loadPlugin("iwlbootstrapper");
        instance.optIn("882784148503943", "IWLBootstrapper", true);
        config.set("882784148503943", "cookie", {
            "fbcParamsConfig": {
                "params": [{
                    "prefix": "",
                    "query": "fbclid",
        ...
        instance.optIn("882784148503943", "FirstPartyCookies", true);
        ...
        config.set("882784148503943", "prohibitedSources", {
            "prohibitedSources": []
        });
        fbq.loadPlugin("prohibitedsources");
        instance.optIn("882784148503943", "ProhibitedSources", true);
        config.set("882784148503943", "unwantedData", {
            "blacklisted_keys": {
                "PageView": {
                    "cd": [],
                    "url": ["ctl00$maincontent$txtemail", "password"]
                }
            },
            "sensitive_keys": {
                "Lead": {
                ...
                "PageView": {
                    "cd": [],
                    "url": ["043a718774c572bd8a25adbeb1bfcd5c0256ae11cecf9f9c3f925d0e52beaf89", "47ae3a282a7f079185cc1c23b3c7995026c885522f6b29f30b75dc65da16db14", "4dfd5ee7abbf3a87a53df32535037fa43f4dc0cdfa32940d6d28edd5205c9a45", "376be72e38bba9182802afedc01055b389d210a3cb9081bf85927b89273b8767", "8f84b89bdc2aa18af73a15328a4761e8d8505100028f2224dd06cef0111c961b", "ce4e9a0dad1eed8d69c713692a749e6b6c486f79156eca3c2e9ae6db22b633e6", "29e60be36f4b0f3a7b39a8fe9f519d311a07846a0fb53cbfad30287fda8084e0", "f284a6ede1e55f8f5e3867eba8c2a87b1d098390dfb54a0bb855d70f3b5b3b24"]
                }
            }
        });
        fbq.loadPlugin("unwanteddata");
        instance.optIn("882784148503943", "UnwantedData", true);
        config.set("882784148503943", "IABPCMAEBridge", {
            "enableAutoEventId": true
        });
        fbq.loadPlugin("iabpcmaebridge");
        instance.optIn("882784148503943", "IABPCMAEBridge", true);
        config.set("882784148503943", "browserProperties", {
            "delayInMs": 200,
        ...
        instance.optIn("882784148503943", "BrowserProperties", true);
        config.set("882784148503943", "eventValidation", {
            "unverifiedEventNames": [],
            "restrictedEventNames": []
        });
        fbq.loadPlugin("eventvalidation");
        instance.optIn("882784148503943", "EventValidation", true);
        config.set("882784148503943", "protectedDataMode", {
            "standardParams": {
        ...
        instance.optIn("882784148503943", "ProtectedDataMode", true);
        config.set("882784148503943", "ccRuleEvaluator", {
            "ccRules": [],
            "wcaRules": [{
                "rule": {
                    "and": [{
        ...
        instance.optIn("882784148503943", "CCRuleEvaluator", true);
        config.set("882784148503943", "clientHint", {
            "delayInMs": 200,
            "disableBackupTimeout": false
        });
        fbq.loadPlugin("clienthint");
        instance.optIn("882784148503943", "ClientHint", true);
        fbq.loadPlugin("lastexternalreferrer");
        instance.optIn("882784148503943", "LastExternalReferrer", true);
        fbq.loadPlugin("cookiedeprecationlabel");
        instance.optIn("882784148503943", "CookieDeprecationLabel", true);
        config.set("882784148503943", "unwantedParams", {
            "unwantedParams": ["predicted_ltv"]
        });
        fbq.loadPlugin("unwantedparams");
        instance.optIn("882784148503943", "UnwantedParams", true);
        config.set("882784148503943", "standardParamChecks", {
            "standardParamChecks": {
                "city": [{
                ...
                "destination_ids": [{
                    "require_exact_match": false,
                    "potential_matches": ["^([\\(\\{\\[]?)\\s*([\"']?)(.{0,2048})?[\"']?\\s*(,\\s*[\"']?(.{0,2048})[\"']?\\s*)*,?[\\)\\}\\]]?$"]
                }],
                "dma_code": [{
                    "require_exact_match": false,
                    "potential_matches": ["^.{0,1000}$"]
                ...
                "drivetrain": [{
                    "require_exact_match": true,
                    "potential_matches": ["4X2", "4X4", "AWD", "FWD", "RWD", "Other", "NONE"]
                }],
                "exterior_color": [{
                    "require_exact_match": false,
                    "potential_matches": ["^.{0,1000}$"]
                ...
                "fuel_type": [{
                    "require_exact_match": true,
                    "potential_matches": ["DIESEL", "ELECTRIC", "GASOLINE", "FLEX", "HYBRID", "OTHER", "PETROL", "PLUGIN_HYBRID", "NONE"]
                }],
                "availability": [{
                    "require_exact_match": true,
                    "potential_matches": ["available_soon", "for_rent", "for_sale", "off_market", "recently_sold", "sale_pending"]
                }],
                "property_type": [{
                    "require_exact_match": true,
                    "potential_matches": ["apartment", "apartment_room", "builder_floor", "bungalow", "condo", "condo_room", "", "house", "house_in_condominium", "house_in_villa", "house_room", "land", "loft", "manufactured", "other", "other_room", "penthouse", "single_family_home", "studio", "townhouse", "townhouse_room"]
                }],
                "listing_type": [{
                    "require_exact_match": true,
                    "potential_matches": ["", "for_rent_by_agent", "for_rent_by_owner", "for_sale_by_agent", "for_sale_by_owner", "foreclosed", "new_construction", "new_listing", "other"]
                }],
                "hotel_score": [{
                    "require_exact_match": false,
                    "potential_matches": ["^-?\\d+(?:\\.\\d+)?$"]
                }],
                "interior_color": [{
                    "require_exact_match": false,
                    "potential_matches": ["^.{0,1000}$"]
                ...
                "preferred_price_range": [{
                    "require_exact_match": false,
                    "potential_matches": ["^\\[\\s*\\d+(\\.\\d+)?\\s*,\\s*\\d+(\\.\\d+)?\\s*\\]$"]
                }],
                ...
                "state_of_vehicle": [{
                    "require_exact_match": true,
                    "potential_matches": ["NEW", "USED", "CPO"]
                }],
                ...
                "transmission": [{
                    "require_exact_match": true,
                    "potential_matches": ["AUTOMATIC", "MANUAL", "OTHER", "NONE"]
                }],
                "travel_class": [{
                    "require_exact_match": true,
                ...
                "body_style": [{
                    "require_exact_match": true,
                    "potential_matches": ["CONVERTIBLE", "COUPE", "CROSSOVER", "ESTATE", "GRANDTOURER", "HATCHBACK", "MINIBUS", "MINIVAN", "MPV", "PICKUP", "ROADSTER", "SALOON", "SEDAN", "SMALL_CAR", "SPORTSCAR", "SUPERCAR", "SUPERMINI", "SUV", "TRUCK", "VAN", "WAGON", "OTHER", "NONE"]
                }],
                "condition_of_vehicle": [{
                    "require_exact_match": true,
                    "potential_matches": ["EXCELLENT", "VERY_GOOD", "GOOD", "FAIR", "POOR", "OTHER", "NONE"]
                }],
                "vin": [{
                    "require_exact_match": false,
                    "potential_matches": ["^.{0,1000}$"]
        ...
        instance.optIn("882784148503943", "StandardParamChecks", true);
        config.set("882784148503943", "actionID", {
            "portNumber": 12387,
            "ttlInHour": 1,
        ...
        instance.optIn("882784148503943", "ActionID", true);
        config.set("882784148503943", "gating", {
            "gatings": [{
        ...
        instance.optIn("882784148503943", "Gating", true);
        instance.configLoaded("882784148503943");
    }
});
